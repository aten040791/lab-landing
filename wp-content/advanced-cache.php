...
// WP-Optimize advanced-cache.php (written by version: 3.4.0) (homeurl: http://localhost/lab-landing/) (abspath: /Volumes/MySDCard/PTIT/_Lab/lab-landing/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/Volumes/MySDCard/PTIT/_Lab/lab-landing/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/lab-landing/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/Volumes/MySDCard/PTIT/_Lab/lab-landing/wp-content/plugins/wp-optimize/cache/extensions');
}
